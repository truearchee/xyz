...
- 2026-06-21 — merged Stage 10 to `main`; landing commit carries the current-state roadmap/STATUS flip and the post-merge Alembic single-head/round-trip + `test_shared_check_union` checks are the immediate landing proof.
