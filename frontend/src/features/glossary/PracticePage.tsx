...
const styles = {
  ...
  fieldset: { border: "1px solid var(--color-border)", borderRadius: 8, display: "grid", gap: 8, padding: 12 },
  legend: { color: "var(--color-text-muted)", fontSize: 12, fontWeight: 700, padding: "0 6px", textTransform: "uppercase" },
  radio: { alignItems: "center", color: "var(--color-text)", display: "flex", fontSize: 14, gap: 8 },
  input: { border: "1px solid var(--color-border)", borderRadius: 6, fontSize: 14, minHeight: 36, padding: "0 10px" },
  muted: { color: "var(--color-text-muted)", fontSize: 14, margin: 0 },
  error: { color: "var(--color-danger-text)", fontSize: 14, margin: 0 },
  result: { border: "1px solid var(--color-border)", borderRadius: 8, display: "grid", gap: 6, padding: 16 },
  resultLine: { color: "var(--color-text)", fontSize: 15, margin: 0 },
  primary: {
