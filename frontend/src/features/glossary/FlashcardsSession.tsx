...
const styles = {
  ...
  progress: { color: "#4b5563", fontSize: 13, fontWeight: 700, margin: 0 },
  card: {
    alignItems: "center",
    background: "#ffffff",
  ...
  term: { color: "#111827", fontSize: 22, fontWeight: 700 },
  muted: { color: "#4b5563", fontSize: 14, fontStyle: "italic" },
  hint: { color: "#6b7280", fontSize: 13, margin: 0, textAlign: "center" },
