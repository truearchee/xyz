...
const styles = {
  block: { border: "1px solid #d7dde8", borderRadius: 8, display: "grid", gap: 14, padding: 16 },
  ...
  modeCard: { ...cardBase, background: "#ffffff" },
  modeCardDisabled: { ...cardBase, background: "#f9fafb", color: "#6b7280" },
  cardTitle: { color: "#111827", fontSize: 15, lineHeight: 1.3, margin: "0 0 4px" },
  cardText: { color: "#4b5563", fontSize: 13, lineHeight: 1.4, margin: 0 },
  cardLink: { color: "#1d4ed8", fontSize: 13, fontWeight: 700, textDecoration: "none" },
  ...
  secondaryButton: {
    background: "#ffffff", border: "1px solid #94a3b8", borderRadius: 6, color: "#174a63",
    cursor: "pointer", fontSize: 13, fontWeight: 700, minHeight: 34, padding: "0 14px",
  },
  iconButton: {
  ...
  modalBackdrop: {
    alignItems: "center", background: "rgba(17, 24, 39, 0.42)", bottom: 0, display: "flex",
    justifyContent: "center", left: 0, padding: 16, position: "fixed", right: 0, top: 0, zIndex: 20,
  },
  modal: {
    background: "#ffffff", borderRadius: 8, boxShadow: "0 24px 80px rgba(15, 23, 42, 0.28)",
  ...
  availableText: { color: "#047857", fontSize: 13, fontWeight: 700, margin: 0 },
  waitingText: { color: "#92400e", fontSize: 13, fontWeight: 700, margin: 0 },
  errorText: { color: "#991b1b", fontSize: 13, margin: 0 },
  list: { display: "grid", gap: 10 },
  scopeRow: {
    alignItems: "center", border: "1px solid #e5e7eb", borderRadius: 8, display: "flex",
    gap: 12, justifyContent: "space-between", padding: 12,
  },
  bankRow: { border: "1px solid #e5e7eb", borderRadius: 8, display: "grid", gap: 4, padding: 12 },
